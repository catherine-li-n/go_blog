...
//Sets the public fields about log
...
//Sets information about the current layer of the call stack
...
//Sets the information of current call stack
...
func (l *Logger) Infof(ctx string, format string, v ...interface{}) {
